...
<body id="page-top">
    ...
    <!-- Basic Details -->
                                    <div class="card-body" style="margin: 0px;">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="patientId"><strong>Patient Id</strong><br></label><input id = "patID" path = "patientId" class="form-control" type="tel" inputmode="numeric" minlength="1" maxlength="6" required="" autofocus="" placeholder="3-6 digits" name="patientId" /></div>
                                                </div>
                                                <div class="col">
    ...
    <!-- Remarks -->
                                                ...
                                                <div class="card-body text-left" style="height: 107px;"><textarea required="" autofocus="" name="remarks" path="remarks" class="form-control-lg" style="height: 108px;width: 270px;" /></textarea></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- Secondary Details                                         -->
                                            <div class="card-body">
                                              <!--  <form id="f2"> -->
                                                    <div class="form-row">
                                                        <div class="col">
                                                            <div class="form-group"><label for="first_name"><strong>Patient Name</strong></label><input required="" autofocus="" path = "patientName" class="form-control" type="text" placeholder="Babu rao" name="patientName" style="margin: -7px;"/></div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="form-group">
    ...
    <!-- Address -->
        ...
        $(function(){
        	...
        	$.ajax({
        		url:"http://localhost:8080/SpringDBMS/admin/getids",
